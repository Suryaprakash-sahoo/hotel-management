  ...
  useEffect(() => {
    ...
    const fetchTable = async () => {
      try {
        ...
        console.log("Fetched table data:", res.data.table);
      } catch (err) {
        console.error(err);
      }
    };
          ...
          <div className="lg:w-2/5 flex flex-col">
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-y-auto flex flex-col h-full">
              <div className="p-4 lg:p-6 bg-gradient-to-r from-blue-600 to-blue-500">
                ...
                <p className="text-blue-100 text-sm">Customer Name: {table?.occupiedByName || "N/A"}</p>
                 <p className="text-blue-100 text-sm">Customer Number: {table?.occupiedByNumber || "N/A"}</p>
                 <p className="text-blue-100 text-sm">Existing Order: {table?.orderId || "N/A"}</p>
              </div>
